...
<div class="content-wrapper">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($name != "" && $description != "") {
                                $query = " UPDATE testimonials SET img = '$img', name = '$name', position = '$position', description = '$description' WHERE id=$id ";
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="image" readonly aria-label="John Doe" name="img" aria-describedby="basic-icon-default-fullname2" value="<?= $receive_data ['img']?>"/>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    ?>
                                                        <label>
                                                            ...
                                                            <img src="../../uploads/<?= $file['img']; ?>" name="img" height="100px" width="100px" class="my-2" alt="">
                                                        </label>
                                                    <?php } ?>
                                                </div>
                                ...
                                <div class="mb-3">
                                    <img src="../../uploads/<?= $receive_data ['img']?>" alt="" style="width: 100px; height:100px" id="showimage" >
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="basic-icon-default-fullname">Name</label>
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="John Doe" aria-label="John Doe" name="name" aria-describedby="basic-icon-default-fullname2" />
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="CEO" aria-label="John Doe" name="position" aria-describedby="basic-icon-default-fullname2" />
                                    </div>
                                </div>
                                <div class="mb-3">
    ...
    <script>
        function firstfunction() {
            ...
            document.getElementById('showimage').value = x;
        }
    </script>
    <!-- / Content -->
