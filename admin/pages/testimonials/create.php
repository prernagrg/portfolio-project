                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($name != "" && $description != "") {
                                $query = "INSERT INTO  testimonials(img, name, position,  description) VALUES('$img','$name','position', '$description') ";
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="image" readonly aria-label="John Doe" name="img" aria-describedby="basic-icon-default-fullname2" />
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    ?>
                                                        <label>
                                                            ...
                                                            <img src="../../uploads/<?= $file['img']; ?>" height="100px" width="100px" class="my-2" alt="">
                                                        </label>
                                                    <?php } ?>
                                                </div>
