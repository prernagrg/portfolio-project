...
<div class="content-wrapper">
    ...
    <?php
            ...
            $offset = ($page - 1) * $limit;
            $count_total_data = "SELECT * FROM files";
...
<div class="container">
    <a class="btn btn-primary btn-sm float-end" href="create.php" role="button">Upload New file</a>
    <div class="table-responsive">
        <table class="table table-primary">
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM files LIMIT $offset ,$limit";
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="../../uploads/<?= $file['img'] ?>" target="_blank"> <img height="100" width="100" src="../../uploads/<?= $file['img'] ?>" alt="image"></a></td>
                        <td>
