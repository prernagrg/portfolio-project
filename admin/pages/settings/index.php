...
<div class="content-wrapper">
    ...
    <?php
            ...
            $offset = ($page - 1) * $limit;
            $count_total_data = "SELECT * FROM site_configs";
        ...
        <table class="table table-primary">
            <thead>
                <tr>
                    ...
                    <th scope="col">Site vaue</th>
                    <th scope="col">Action</th>
                </tr>
            </thead>
            <tbody>
                <?php
                $query = "SELECT * FROM site_configs LIMIT $offset ,$limit";
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $file['site_key'] ?></td>
                        <td><?php echo $file['site_value'] ?></td>
