          ...
          <div class="card-body">
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($profession != "" && $birthday != "" && $website != "" && $phone != "" && $city != "" && $age != "" && $degree != "" && $email != "" && $freelance != "" && $description != "" && $img != "") {
                $query = "UPDATE abouts SET profession = '$profession', birthday = '$birthday', website = '$website', phone = '$phone', city = '$city', age = '$age', degree = '$degree', email = '$email', freelance = '$freelance', description = '$description', img = '$img' WHERE id = $id ";
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input type="text" id="imagebox" class="form-control" name="img" aria-describedby="basic-icon-default-company2" />
