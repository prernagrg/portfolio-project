            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                if(isset($_GET['id'])){
                    ...
                    $select_data="SELECT * FROM homes WHERE id=$id";
                ...
                ?>
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if($name != "" && $title != "" && $img != "" ){
                           $query = "UPDATE homes SET name='$name', title='$title', img='$img'";
