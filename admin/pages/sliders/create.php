        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($name != "" && $title != "" && $img != "") {
                $query = "INSERT INTO  homes(name, title, img) VALUES('$name', '$title', '$img') ";
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                  <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="John Doe" aria-label="John Doe" name="title" aria-describedby="basic-icon-default-fullname2" />
                </div>
              </div>
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input type="text" id="imagebox" class="form-control" name="img" aria-describedby="basic-icon-default-company2" readonly />
